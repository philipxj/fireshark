...
This is the canonical agent guidance file for this repository. It applies to Codex, Claude Code, and other coding agents working on the Fireshark Tech website.
...
5. **Twindle** — Daily twin-equation math puzzle for web and Android. iOS link is intentionally absent until the native app ships.
